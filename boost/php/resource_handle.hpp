...
#ifndef BOOST_RESOURCE_HANDLE_HPP
#define BOOST_RESOURCE_HANDLE_HPP

namespace boost { namespace php {

class resource_handle {
public:
    resource_handle(): value_() {}

    explicit resource_handle(long value): value_(value) {}
...
#endif /* BOOST_PHP_RESOURCE_HANDLE_HPP */
